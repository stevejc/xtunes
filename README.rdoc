...
3. Ransack was used to add search functinality for the songs and to add sorts to the songs tables to make finding songs much easier.
...
8. Annotate and Pry was used to assist in development. 
